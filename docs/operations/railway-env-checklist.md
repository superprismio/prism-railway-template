...
- set the Discord adapter env refs if Codex agents should directly resolve destinations or send one-off Discord messages; scheduled task output delivery can still be handled by `task-runner`
