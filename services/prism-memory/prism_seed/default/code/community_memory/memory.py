...
class RollingMemoryBuilder:
    ...
    def run(self, target_date: date, force: bool = False) -> str | None:
        ...
        previous_payload = read_json(memory_path, default={})
        current_schema = isinstance(previous_payload, dict) and previous_payload.get('recap_schema_version') == 2
        if not force and current_schema and _digest_paths_are_fresh(freshness_paths, [md_path, memory_path]):
        ...
        payload = {
            ...
            # Deprecated compatibility field; generated registries no longer feed recaps.
            "current_throughlines": [],
            "recap_schema_version": 2,
