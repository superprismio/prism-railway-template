...
16. For Portal email queue dispatch, use the built-in `portal-email-dispatch` task. Do not create a recurring `codex-prompt` task for five-minute email dispatch.
