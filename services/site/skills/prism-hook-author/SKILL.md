...
11. Capability dependencies belong to the workflow's skills. Hooks should not
    carry duplicated Gateway capability lists. Run Prism Doctor before enabling
    a hook whose workflow uses a migrated integration.
