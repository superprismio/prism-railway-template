...
const codegenAgentSnapshot = {
  key: 'codegen-agent',
  name: 'Codegen Agent',
  description: 'Protected implementation orchestrator for approved repository changes with bounded native Codex delegation.',
  status: 'active',
  ...
  persona: {
    ...
    instructions: [
      ...
      'Use native Codex subagents only for independent, bounded work with disjoint ownership; prefer explorer for read-heavy mapping and worker for focused implementation.',
      ...
      'Review every subagent result before integrating it, preserve unrelated work, and stop for operator attention when the approved scope or authority is insufficient.',
    ].join(' '),
  },
...
export const codegenAgentMigration: Migration = {
  ...
  sql: `
    INSERT OR IGNORE INTO agent_profiles (
      ...
      'codegen-agent',
      'Codegen Agent',
      'Protected implementation orchestrator for approved repository changes with bounded native Codex delegation.',
      'active',
      'codegen-agent',
      'agent',
      'agent-profile-admin',
