    ...
    <main className="min-h-screen px-4 py-6 text-foreground md:px-6 lg:px-8">
      <div className="mx-auto grid max-w-6xl gap-6 lg:grid-cols-[1.2fr_0.8fr]">
        <section className="rounded-[32px] border border-border/60 bg-card/90 p-8 shadow-[0_24px_80px_-36px_rgba(26,31,44,0.45)] backdrop-blur md:p-10">
          ...
          <h1 className="mt-4 max-w-3xl text-5xl leading-none tracking-tight md:text-7xl">
            Change requests in front, controlled agent execution behind.
          </h1>
          <p className="mt-6 max-w-2xl text-lg leading-8 text-muted-foreground">
            This stack is evolving into a request board that can route work to
            review branches, feed context from Prism Memory, and keep production
